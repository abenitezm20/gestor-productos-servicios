...
from src.commands.productos_servicios_deportista.listar_productos_servicios_deportista import ListarProductosServiciosDeportista
...
# @productos_servicios_deportista_blueprint.route('/agregar', methods=['POST'])
# @token_required
